...
// ── Auth (debug-grade: plaintext users.json, no hashing/sessions/tokens) ────
// NBA: registration has no function in this demo — only the two seeded
// accounts below (Admin/Demo, Member/Demo) can log in.
