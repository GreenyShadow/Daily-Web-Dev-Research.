...
- `docs/diagrams/use-case-diagram.svg`, `erd.svg`, `class-diagram.svg`, `architecture-diagram.svg`.
...
Full actor/use-case map: `docs/diagrams/use-case-diagram.svg`. Table below assigns stable IDs referenced by the functional requirements in §4.
