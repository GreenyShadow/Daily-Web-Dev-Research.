...
import { DEPARTMENTS, PRIORITIES, isExpired, isUnprocessed, sortByCreatedAt } from '../../lib/constants.js';
...
export default function MemberPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return sortByCreatedAt(list, sortOrder);
  }, [tickets, filter, search, sortOrder]);
  ...
  return (
    <Shell tabs={TABS} activeTab={tab} onTabChange={setTab}>
      ...
      {selected && editing && editForm && (
        <Modal title="Edit request" onClose={() => setEditing(false)} width={480}>
